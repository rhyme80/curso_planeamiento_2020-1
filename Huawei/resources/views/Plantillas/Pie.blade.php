...
<footer>
      ...
      <div class="line">
        <div class="margin">
          ...
          <div class="s-12 m-12 l-4 margin-m-bottom-30">
            <h3 class="text-size-16">Huawei</h3>
            <p class="text-size-14">
               Responsive Street 7<br>
               Banxuegang Industrial Park, Buji Longgang - Guangdong<br> 
               China
            </p>               
          </div>
          <!-- Collumn 2 -->
          <div class="s-12 m-12 l-4 margin-m-bottom-30">
            ...
            <p class="text-size-14">
               Huawei@enterprice.com<br>
               office@sampledomain.com
            </p>              
          </div>
          <!-- Collumn 3 -->
          <div class="s-12 m-12 l-4 ">
            <h3 class="text-size-16">Telefonos</h3>
            <p class="text-size-14">
               0800 4521 800 50<br>
               0450 5896 625 16<br>
               0798 6546 465 15
    ...
    <section class="padding background-dark full-width">
      <div class="text-center">
        <p class="text-size-12">Copyright 2020, Huawei.</p>
        <p class="text-size-12">Todos los derechos reservados.</p>
      </div>
    </section>
  </footer>
</div>
<script type="text/javascript" src="{!! asset('Estilos/js/responsee.js') !!}"></script>
<script type="text/javascript" src="{!! asset('Estilos/js/jquery.events.touch.js') !!}"></script>
<script type="text/javascript" src="{!! asset('Estilos/owl-carousel/owl.carousel.js') !!}"></script>
<script type="text/javascript" src="{!! asset('Estilos/js/template-scripts.js') !!}"></script> 
</body>
</html>